...
public interface ServiceLifecycleManager {
   ...
   */
  File replaceOMDBWithCheckpoint(long lastAppliedIndex,
      File oldDB, Path checkpointPath) throws IOException;

  /**
   * Get the old DB location.
   * @return File representing the old DB location
   */
   ...
   */
  void startRpcServer() throws IOException;
